...
var require$$1 = /*@__PURE__*/getAugmentedNamespace(index_esm$1);
...
var targetNamespace = function() {
  ...
  function check(node, reporter) {
    if (is$1(node, 'bpmn:Definitions') && !node.targetNamespace) {
...
cache['bpmnlint-plugin-playground/target-namespace'] = targetNamespace;
cache['bpmnlint-plugin-playground/no-manual-task'] = noManualTask;
